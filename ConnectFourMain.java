...
public class ConnectFourMain {
	...
	static class ConnectFourGame extends JPanel implements MouseListener, ActionListener { //JPanel extended::
		...
		public void paintComponent(Graphics graphics) {	
			//The Graphics2D object contains an AffineTransform object as part of its rendering state that defines how to convert coordinates from user space to device-dependent coordinates in Device Space. ... Every Graphics2D object is associated with a target that defines where rendering takes place.
